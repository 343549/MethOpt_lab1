...
Для демонстрации работы программы возьмём ЗЛП из варианта №1 (номер моей позиции в потоке - 11, остаток от деления на 20 - 1) (данная ЗЛП уже была частично разобрана выше):
